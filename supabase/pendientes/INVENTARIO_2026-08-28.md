...
| 2 | **Servicios de precio fijo — las 8 piezas de UI** · 🟡 **piezas 1–3 + REGLA A (categoría única, cierra el exploit de mezclar) HECHAS 30/8** (`PricingCalculator` 974/974 contra la base · chips `Sauna · 14 cr` · renglón "precio único" en la grilla) | Faltan: pantalla del backoffice, snackbar de rechazo al guardar, Explorar sin badge |
